    ...
    const recentArticles = [
        {
            ...
            excerpt: "Postecoglou defends Tottenham after Liverpool defeat, Premier League debates celebration rules, PFA threatens legal action.",
            url: "./latest-epl-news-2025-02-07.html",
        ...
        },
        {
            ...
            url: "./liverpool-triumph-over-bournemouth-2025-02-02.html",
            image: "../upscalemedia-transformed.png"
        },
        {
            ...
            url: "./bournmouth-vs-liverpool-heavily-anticipated-match-preview-2025-01-31.html",
            image: "../upscalemedia-transformed.png"
        },
        {
            ...
            url: "./michal-oliver-banned-from-reffing-arsenal-games-01-27-2025.html",
            image: "../upscalemedia-transformed.png"
        },
        {
            ...
            url: "./Manchester-Uniteds-worst-team-in-years-20-01-2025.html",
            image: "../upscalemedia-transformed.png"
        },
        {
            ...
            url: "./eze-free-kick-disallowed-chelsea-var-2025-01-17.html",
            image: "../upscalemedia-transformed.png"
        },
        {
            ...
            url: "./nottingham-forest-rises-to-an-incredible-third-in-the-epl-standings-01-06-2025.html",
            image: "../upscalemedia-transformed.png"
        },
        {
            ...
            url: "./a-new-year-a-new-football-2025-edition-01-05-2025.html",
            image: "../upscalemedia-transformed.png"
        }
    ];

    function loadReadNextArticles() {
        const grid = document.getElementById('readNextGrid');
        if (!grid) return;
